...
ping -n 1 10.134.202.21
IF ERRORLEVEL 1 GOTO NOTLAN

msg * "Machine is in office. Closing lid will not put laptop to sleep". 
...
IF ERRORLEVEL 1 GOTO NOTWIFIMUS
...
:NOTWIFIMUS
msg * "Machine is not in office. Closing lid will put laptop to sleep". 
